						...
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationList as spec>
								<dl>
									...
									<#list spec.specificationOptions as item>
										<dd>
											<a href="javascript:;" :class="isSelected('${spec.specName}','${item.optionName}')?'selected':''"
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a @click="addToCart" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
	...
	new Vue({
		...
		methods:{
			...
			addToCart:function () {//加入购物车
				axios.get("http://127.0.0.1:8084/cart/addGoodsToCartList",
						{params:{itemId:this.sku.id,num:this.num}})
						.then(function (response) {
							if (response.data.isSuccess){
								location.href="http://127.0.0.1:8084/cart.html";
							} else {
